...
const getModelSchema = modelToGet => {
  const model = require(`./${modelToGet}/domains/models/${getSingularCollectionName( modelToGet )}.models.js`)( Schema )
...
const getModel = ( connection, modelToGet = '' ) => {
  ...
  return ( connection && connection.models && connection.models[ capitalizedModelName ] )
    ...
    : connection.model( capitalizedModelName,  getModelSchema( modelToGet ) )
}
